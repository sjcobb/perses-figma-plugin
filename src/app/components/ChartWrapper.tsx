...
export function ChartsWrapper(props: EChartsWrapper) {
  const { option, theme, onChartReady, onEvents, width, height } = props;
  ...
  useLayoutEffect(() => {
    ...
    // TODO: support passing theme, optional svg renderer
    const chart = init(containerRef, theme, { renderer: "svg" });
